...
type ResponseCallback<T> = (error?: Error | DOMException | AJAXError | null, data?: T | null, headers?: Headers) => void;
...
type ArrayPropertySpecification = {
	type: "array";
...
type BooleanPropertySpecification = {
	type: "boolean";
	"property-type": ExpressionType;
	expression?: ExpressionSpecification$1;
	transition?: boolean;
...
type ColorPropertySpecification = {
	type: "color";
	"property-type": ExpressionType;
	expression?: ExpressionSpecification$1;
	transition?: boolean;
...
type EnumPropertySpecification = {
	type: "enum";
	"property-type": ExpressionType;
	expression?: ExpressionSpecification$1;
	transition?: boolean;
...
type FormattedPropertySpecification = {
	type: "formatted";
	"property-type": ExpressionType;
	expression?: ExpressionSpecification$1;
	transition?: boolean;
...
type NumberPropertySpecification = {
	type: "number";
	"property-type": ExpressionType;
	expression?: ExpressionSpecification$1;
	transition?: boolean;
...
type ResolvedImagePropertySpecification = {
	type: "resolvedImage";
	"property-type": ExpressionType;
	expression?: ExpressionSpecification$1;
	transition?: boolean;
...
type StringPropertySpecification = {
	type: "string";
	"property-type": ExpressionType;
	expression?: ExpressionSpecification$1;
	transition?: boolean;
...
type StylePropertySpecification = ArrayPropertySpecification | BooleanPropertySpecification | ColorPropertySpecification | EnumPropertySpecification | FormattedPropertySpecification | NumberPropertySpecification | ResolvedImagePropertySpecification | StringPropertySpecification;
...
declare class SymbolAppearance {
	...
	hasCachedIconPrimary(): boolean;
	setCachedIconPrimary(iconPrimary: ImageVariant): void;
	getCachedIconPrimary(): ImageVariant;
	...
	recalculate(parameters: EvaluationParameters, availableImages: ImageId[], iconImageUseTheme?: string): void;
...
declare class SymbolStyleLayer extends StyleLayer {
	...
	getAppearanceValueAndResolveTokens<T extends keyof AppearanceProps>(appearance: SymbolAppearance, name: T, feature: Feature, canonical: CanonicalTileID, availableImages: ImageId[]): string | LayoutProps[T];
...
declare class SymbolBuffers {
	...
	isEmpty(): boolean;
	getIconVertexData(offset: any, numVertices: any): number[];
	updateIconVertexData(vertexIndex: number, anchorX: number, anchorY: number, newOx: number, newOy: number, newTx: number, newTy: number, newSizeX: number, newSizeY: number, pixelOffsetX: number, pixelOffsetY: number, minFontScaleX: number, minFontScaleY: number): void;
	upload(context: Context, dynamicIndexBuffer: boolean, upload?: boolean, update?: boolean, createZOffsetBuffer?: boolean, hasAppearances?: boolean): void;
	destroy(): void;
}
...
declare class SymbolBucket implements Bucket {
	...
	calculateEffectiveAppearanceIconSize(activeAppearance: SymbolAppearance, currentZoom: number, evaluationFeature: EvaluationFeature, canonical: CanonicalTileID, availableImages: Array<ImageId>, iconScaleFactor: number): number;
	...
	getResolvedImageFromTokens(tokens: string): ResolvedImage;
	...
	getCombinedIconPrimary(appearance: SymbolAppearance, layer: SymbolStyleLayer, evaluationFeature: EvaluationFeature, canonical: CanonicalTileID, availableImages: ImageId[], symbolFeature: SymbolFeature, iconScaleFactor: number): ImageVariant | undefined;
	...
	updateAppearances(canonical?: CanonicalTileID, featureState?: FeatureStates, availableImages?: Array<ImageId>, globalProperties?: GlobalProperties): boolean;
	...
	addSymbols(arrays: SymbolBuffers, quads: Array<SymbolQuad>, sizeVertex: number[], lineOffset: [
		number,
		number
	], alongLine: boolean, feature: SymbolFeature, writingMode: number | undefined, globe: GlobeData | null | undefined, tileAnchor: Anchor, lineStartIndex: number, lineLength: number, associatedIconIndex: number, availableImages: ImageId[], canonical: CanonicalTileID, brightness: number | null | undefined, hasAnySecondaryIcon: boolean, symbolInstanceIndex: number, maxQuadCount: number): void;
	_addNullVertices(num: number, layoutVertexArray: StructArrayLayout4i4ui4i24, sizeVertex: number[], globe: GlobeData, globeExtVertexArray: StructArrayLayout3i3f20, arrays: SymbolBuffers, hasAnySecondaryIcon: boolean, segment: Segment, indexArray: StructArrayLayout3ui6): void;
...
type ModelMaterialOverrides = Map<string, MaterialOverride>;
type ModelNodeOverrides = Map<string, NodeOverride>;
declare class Model {
	id: string;
	position: LngLat;
	orientation: [
	...
	nodeOverrides: ModelNodeOverrides;
	materialOverrideNames: string[];
	nodeOverrideNames: string[];
	featureProperties: Record<string, unknown>;
	uri: string;
	constructor(id: string, uri: string, position: [
		number,
		number
...
declare class Style$1 extends Evented<MapEvents> {
	...
	setIndoorData(mapId: string, params: ActorMessages["setIndoorData"]["params"]): void;
	updateIndoorDependentLayers(): void;
	...
	_updateLayers(layerIds: Set<string>, condition?: (layer: TypedStyleLayer) => boolean): void;
	...
	setLayerProperty<T extends keyof (PaintSpecification | LayoutSpecification)>(layerId: string, name: T | "appearances", value: PaintSpecification[T] | LayoutSpecification[T] | AppearanceSpecification[], options?: StyleSetterOptions): void;
	/**
...
declare class CircleBucket<Layer extends CircleStyleLayer | HeatmapStyleLayer = CircleStyleLayer | HeatmapStyleLayer> implements Bucket {
	...
	updateFootprints(_id: UnwrappedTileID, _footprints: Array<TileFootprint>): void;
	updateAppearances(_canonical?: CanonicalTileID, _featureState?: FeatureStates, _availableImages?: Array<ImageId>, _globalProperties?: GlobalProperties): void;
	populate(features: Array<IndexedFeature>, options: PopulateParameters, canonical: CanonicalTileID, tileTransform: TileTransform): void;
	update(states: FeatureStates, vtLayer: VectorTileLayer, availableImages: ImageId[], imagePositions: SpritePositions, layers: ReadonlyArray<TypedStyleLayer>, isBrightnessChanged: boolean, brightness?: number | null): void;
	isEmpty(): boolean;
	uploadPending(): boolean;
...
type FillExtrusionDefinesType = "CLEAR_FROM_TEXTURE" | "CLEAR_SUBPASS" | "FAUX_AO" | "FLOOD_LIGHT" | "HAS_CENTROID" | "RENDER_WALL_MODE" | "SDF_SUBPASS" | "ZERO_ROOF_RADIUS" | "FILL_EXTRUSION_PATTERN_TRANSITION" | "HAS_ATTRIBUTE_a_flood_light_ground_radius";
...
declare class PerModelAttributes {
	...
	maxScale: number;
	maxXYTranslationDistance: number;
	constructor();
	colorForInstance(index: number): [
		number,
		number,
		number,
		number
...
declare class ModelStyleLayer extends StyleLayer {
	...
	cutoffRange(): number;
	queryRadius(bucket: Bucket): number;
	queryRenderedFeatures(queryGeometry: QueryGeometry, sourceCache: SourceCache, transform: Transform$1): QueryResult;
...
declare class FillExtrusionStyleLayer extends StyleLayer {
	type: "fill-extrusion";
	_unevaluatedLayout: Layout<LayoutProps$4>;
...
declare class GroundEffect {
	...
	indexArray: StructArrayLayout3ui6;
	indexBuffer: IndexBuffer;
	groundRadiusArray: StructArrayLayout1f4;
	groundRadiusBuffer: VertexBuffer;
...
declare class BuildingGeometry {
	...
	layoutFloodLightDataArray: StructArrayLayout1ui2;
	layoutFloodLightDataBuffer: VertexBuffer;
	layoutAOArray: StructArrayLayout1f4;
	indexArray: StructArrayLayout3ui6;
	indexArrayForConflation: StructArrayLayout3ui6;
	indexBuffer: IndexBuffer;
	segmentsBucket: SegmentVector;
...
declare class BuildingBucket implements BucketWithGroundEffect {
	...
	featureFootprintLookup: Map<number, number>;
	footprintLookup: {
...
declare class SourceCache extends Evented {
	...
	_tileLoaded(tile: Tile, id: number, previousState: TileState, err?: AJAXError | null, data?: LoadVectorTileResult | null): void;
	/**
...
declare class Elevation {
	...
	static getAtTileOffsetFunc(tileID: OverscaledTileID, lat: number, worldSize: number, projection: Projection$2): (arg1: Point, arg2: Elevation, arg3?: ElevationFeature) => [
		number,
		number,
		number
	];
...
declare class FreeCameraOptions {
	 ...
	 */
	lookAtPoint(location: LngLatLike, up?: vec3, altitude?: number): void;
	/**
...
declare class StyleLayer extends Evented {
	...
	setAppearances(appearances: AppearanceSpecification[]): void;
...
type PropertyValueSpecifications<Props> = Partial<{
	[Key in keyof Props]: Props[Key] extends Property<infer T, unknown> ? PropertyValueSpecification<T extends Color ? string : T> : never;
}>;
...
declare class Tile {
	...
	upload(context: Context, painter?: Painter): void;
	...
	hasAppearances(painter: Painter): boolean;
...
export declare class VectorTileSource extends Evented<SourceEvents> implements ISource<"vector"> {
	...
	loadTile(tile: Tile, callback: Callback<WorkerSourceVectorTileResult>): void;
	abortTile(tile: Tile): void;
	unloadTile(tile: Tile, _?: Callback<undefined> | null): void;
	hasTransition(): boolean;
	afterUpdate(): void;
...
export declare class ModelSource extends Evented<SourceEvents> implements ISource {
	...
	load(): void;
	private static applyModelSpecification;
	private static convertNodeOverrides;
	private static convertMaterialOverrides;
	onAdd(map: Map$1): void;
	hasTransition(): boolean;
	loaded(): boolean;
	 ...
	 * });
	 */
	setModels(modelSpecs: ModelSourceModelsSpecification): void;
}
...
declare class IndoorManager extends Evented<IndoorEvents> {
	...
	setActiveFloorsVisibility(activeFloorsVisible: boolean): void;
	setIndoorData(indoorData: IndoorData): void;
	getIndoorTileOptions(sourceId: string, scope: string): IndoorTileOptions | null;
	_updateUI(zoom: number, mapCenter: LngLat, mapBounds: LngLatBounds): void;
	_updateIndoorSelector(): void;
	_updateActiveFloors(): void;
}
declare class Hash {
...
declare class Map$1 extends Camera {
	...
	*/
	 ...
	 */
	setLayerProperty<T extends keyof (LayoutSpecification | PaintSpecification)>(layerId: string, name: T, value: LayoutSpecification[T] | PaintSpecification[T], options?: StyleSetterOptions): this;
	...
	_setIndoorActiveFloorsVisibility(activeFloorsVisible: boolean): void;
	...
	******************************************************************************/
	...
	_postStyleWithAppearanceEvent(): void;
	_updateTerrain(): void;
...
declare class IndoorControl implements IControl {
	...
	addBuildingsToggleButton(): void;
	_updateBuildingsButtonState(): void;
	addCurrentFloors(floors: Array<IndoorControlFloor>, showSelectedFloor: boolean): void;
}
