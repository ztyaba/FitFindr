    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                className="absolute bottom-32 md:bottom-40 left-1/2 transform -translate-x-1/2 z-[150] w-[calc(100%-2rem)] md:w-full max-w-lg px-0 md:px-4"
            >
                <motion.div
                    layout
                        ...
                        >
                            ...
                            <div className={`relative h-40 w-full overflow-hidden ${isGame ? 'bg-gradient-to-br from-emerald-900/60 to-blue-900/60' : 'bg-gradient-to-br from-purple-900/60 to-indigo-900/60'}`}>
                                ...
                                <div className="absolute bottom-6 left-6 flex items-center gap-4">
                                    <div className={`w-16 h-16 rounded-2xl ${isGame ? 'bg-emerald-500/20' : 'bg-purple-500/20'} flex items-center justify-center border border-white/10`}>
                                        {isGame ? (
